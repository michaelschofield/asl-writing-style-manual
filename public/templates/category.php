<?php get_header(); ?>
			...
			<div id="content">
				...
				<div id="inner-content" class="clearfix wrap">
					...
					<header>
						<h1 class="archive-title hide-accessible"> Search Results: "<?php echo esc_attr(get_search_query()); ?>"</h1> <br>
					</header>
						...
						$args = array(
							'post_type' => array( 'reference', 'usage', 'formatting'),
							'category_name' => $qobj->slug
						);
